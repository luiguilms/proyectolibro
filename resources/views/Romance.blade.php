    ...
    <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
        <div class="row">
          <div class="col-7">
            ...
            <p class="lead mb-0"><a href="https://www.planetadelibros.com.pe/libros/novelas-romanticas/00014" class="text-white font-weight-bold">Comprar libros similares.</a></p>
          </div>
          <div class="col-5">
